...
public class ModClubUserConfiguration : IEntityTypeConfiguration<ModClubUser>
{
    public void Configure(EntityTypeBuilder<ModClubUser> builder)
    {
        builder.HasKey(e => e.Id).HasName("PRIMARY");

        builder.ToTable("mod_club_user");
        ...
        builder.Property(e => e.AgreeData20Years)
            .IsRequired()
            .HasDefaultValueSql("'1'")
            .HasColumnName("agree_data_20_years");
        ...
        builder.Property(e => e.Dob)
            ...
            .HasColumnType("date")
            .HasColumnName("dob");
        //.HasConversion(new MyDateConversion());

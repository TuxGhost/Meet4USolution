...
public class ModMailinglistSubscriptionConfiguration : IEntityTypeConfiguration<ModMailinglistSubscription>
{
    public void Configure(EntityTypeBuilder<ModMailinglistSubscription> builder)
    {
        builder.HasKey(e => e.Id).HasName("PRIMARY");

        builder.ToTable("mod_mailinglist_subscription");
